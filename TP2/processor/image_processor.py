...
---------------------------
Descarga y procesa imágenes, generando thumbnails utilizando Pillow.
"""
...
def process_images(request):
    ...
    Args:
        request (dict): Contiene una lista de URLs de imágenes.

    Returns:
        dict: Contiene los thumbnails generados en Base64 o mensajes de error.
    """
